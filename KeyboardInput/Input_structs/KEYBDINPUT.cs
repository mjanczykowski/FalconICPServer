...
namespace KeyboardInput
{
    ...
    struct KEYBDINPUT
    {
        ...
        /// KEYEVENTF_UNICODE       If specified, the system synthesizes a VK_PACKET keystroke. The wVk parameter must be zero. This flag can only be combined with the KEYEVENTF_KEYUP flag. For more information, see the Remarks section.</summary>
